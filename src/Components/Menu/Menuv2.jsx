        ...
        <div>
            ...
            {openMenu ? (
                ...
                className="bg-brandcream h-screen w-screen fixed top-0 left-0 z-40">
                    ...
                    <Link to='/aboutMe' className="text-6.3vw grid place-content-center h-[4rem] sm:h-[5rem] md:h-[6rem] 
                    lg:h-[8rem] xl:h-[10rem] 2xl:h-[17rem]">ABOUT ME ~</Link>
                    ...
                    <link href='/projects' className="text-6.3vw grid place-content-center h-[4rem] sm:h-[5rem] md:h-[6rem] 
                    lg:h-[8rem] xl:h-[10rem] 2xl:h-[17rem]">PROJECT ~</link>
            ...
            ) :  <button onClick={MenuTog}><SlMenu className=" z-50 text-brandblack fixed right-5 top-5 text-2xl"/></button>}
        </div>
        
    )
}

export default MenuSecondVersion;